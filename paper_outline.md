...
- **Hasil**: Model SVC berbasis fusi fitur tri-domain (`Face ⊕ Emotion ⊕ Age`) meraih performa tertinggi di antara metode yang dibandingkan dengan **akurasi 93.70%**, **Precision 0.9372**, **Recall 0.9370**, dan **F1-Score 0.9369**.
- **Kesimpulan**: Fusi fitur tri-domain mencapai performa terbaik pada tiga dari empat classifier yang dievaluasi, dengan nilai F1-Score pada keenam subkelompok berada pada kisaran 0.9174 hingga 0.9614.
